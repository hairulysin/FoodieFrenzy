...
if(isset($_POST['submit'])){
   ...
   $address = 'Jln.'.$_POST['area'] .','.'No.'.$_POST['flat'].', '.$_POST['city'].', '.$_POST['pin_code'];
...
<section class="form-container">
   ...
   <form action="" method="post">
      <h3>your address</h3>
      <input type="text" class="box" placeholder="House Number" required maxlength="50" name="flat">
      <!-- <input type="text" class="box" placeholder="building no." required maxlength="50" name="building"> -->
      <input type="text" class="box" placeholder="Street Address" required maxlength="50" name="area">
