...
if(isset($_POST['update'])){
   ...
   $update_product = $conn->prepare("UPDATE `products` SET name = ?, category = ?, price = ?, deskripsi = ? WHERE id = ?");
   $update_product->execute([$name, $category, $price, $deskripsi, $pid]);
...
<section class="update-product">
   ...
   <form action="" method="POST" enctype="multipart/form-data">
      ...
      <textarea name="deskripsi" placeholder="Enter product description" class="box"><?= $fetch_products['deskripsi']; ?></textarea>
